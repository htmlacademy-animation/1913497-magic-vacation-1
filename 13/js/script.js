...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _canvas_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas-utils */ "./source/js/modules/canvas-utils.js");
...
const drawCalf = (passed) => {
  ...
  durations.forEach((el, index) => {
    ...
    if (passed > sum && passed < sum + el) {
      translateCalfY = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(translateFrom, translateTo, progress);
      rotateCalf = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(rotateFrom, rotateTo, progress);
    }
...
const drawSnows = (passed) => {
  ...
  const opacityProgress = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"])(
  ...
  if (passed > from && passed > snowTranslateFrom && passed < snowTranslateTo) {
    ...
    leftSnowTranslateY = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
  ...
  if (
    ...
    rightSnowTranslateY = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
...
const drawTree = (passed) => {
  ...
  const duration = 400;
  const progress = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"])(Math.min((passed - from) / duration, 1));

  if (passed > from && passed < from + duration) {
    showTree = progress * 1;
    translateYTree = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
...
const drawBackAndAirPlane = (passed) => {
  ...
  const airplaneProgress = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["cubicBezier"])(animationProgress, 0.2, 0, 0.4, 1);
  ...
  if (passed > from && passed < from + animationDuration) {
    backRadius = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
        backStartRadius,
        maxBackCicleRadius,
        airplaneProgress
    );
    backCenterYPoint = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
        backTopYPoint + backStartRadius,
        backTopYPoint + maxBackCicleRadius,
        airplaneProgress
    );
    const currentPos = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getBezierPoint"])(
        airplaneProgress,
        airplanePathPoint1,
        airplanePathPoint2,
        airplanePathPoint3,
    ...
    curveFirstPoint = {
      x: Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
          backXAxios + (airplaneXPosition - backXAxios) * 0.6,
          backXAxios + (airplaneXPosition - backXAxios) * 0.4,
          airplaneProgress
      ),
      y: Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
    ...
    arcPointY = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
    ...
    airplaneRotate = Object(_canvas_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(aitplaneRotateFrom, 0, airplaneProgress);
...
/***/ "./source/js/modules/canvas-utils.js":
/*!*******************************************!*\
  !*** ./source/js/modules/canvas-utils.js ***!
  \*******************************************/
/*! exports provided: rotateCtx, easeOut, easeIn, easeInOut, getAnimationTick, getBezierPoint, cubicBezier */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
