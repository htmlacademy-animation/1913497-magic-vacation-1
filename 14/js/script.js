...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/make-typegraphy-accent.js */ "./source/js/modules/make-typegraphy-accent.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(introTitle, {
    ...defaultAnimationRules,
  });

  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(introDate, {
    ...defaultAnimationRules,
    duration: 0.5,
    delay: 1.25,
  });

  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(sliderTitle, {
    ...defaultAnimationRules,
    duration: 0.75,
  });

  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(prizesTitle, {
    ...defaultAnimationRules,
    duration: 0.5,
    delay: 0.5,
  });

  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(rulesTitle, {
    ...defaultAnimationRules,
    duration: 0.5,
  });

  Object(_modules_make_typegraphy_accent_js__WEBPACK_IMPORTED_MODULE_0__["default"])(gameTitle, {
    ...defaultAnimationRules,
    duration: 0.75,
  });
});
...
/***/ "./source/js/modules/apply-lose-canvas.js":
/*!************************************************!*\
  !*** ./source/js/modules/apply-lose-canvas.js ***!
  \************************************************/
/*! exports provided: default */
...
const drawKey = (passed) => {
  const duration = 300;
  const progress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, 0, duration, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const x = (keyX * ww) / 100;
  const y = (keyY * wh) / 100;

  keyScale = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(keyScaleFrom, 1, progress);

  loseCtx.globalAlpha = progress * 1;
  Object(_utils__WEBPACK_IMPORTED_MODULE_0__["scaleCtx"])(loseCtx, x, y, keyScale);
...
const drawObjects = (passed) => {
  ...
  const progressOut = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, from, durationOut, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const progressIn = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(
      passed,
      from + durationOut,
      durationIn,
      _utils__WEBPACK_IMPORTED_MODULE_0__["easeIn"]
  );
  const ws = ww / 100;
  const hs = wh / 100;
  const size = Math.min(ws, hs) * objectSize;

  objectScale = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(0, 1, progressOut);

  for (const [key, value] of Object.entries(objects)) {
    objects[key].x = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(keyX, value.xTo, progressOut);
    if (!progressIn) {
      objects[key].y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(keyY, value.yTo, progressOut);
    } else {
      objects[key].y = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(value.yTo, 120, progressIn);
    }
    objects[key].rotate = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
    ...
    loseCtx.save();
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["scaleCtx"])(loseCtx, objects[key].x * ws, objects[key].y * hs, objectScale);
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["rotateCtx"])(
        loseCtx,
        objects[key].rotate,
        objects[key].x * ws,
        objects[key].y * hs
...
const drawCrocodile = (passed) => {
  const from = 900;
  const duration = 600;
  const progress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, from, duration, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const ws = ww / 100;
  const hs = wh / 100;
  const x = keyX * ws;
  const y = keyY * hs;
  ...
  crocodileX = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(x + crocodileSize / 2, x, progress);
  crocodileY = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
      y - crocodileSize / 7,
      y + keyHeight / 5,
      progress
  );
...
const drawDrop = (passed) => {
  const duration = 400;
  const scaleProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, dropFromStage, duration, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const moveProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(
      passed,
      dropFromStage + duration,
      duration,
      _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]
  );
  const opacityProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(
      passed,
  ...
  dropYPosition = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(dropYFrom, dropYTo, moveProgress);
  dropOpacity = 1 - opacityProgress * 1;
  Object(_utils__WEBPACK_IMPORTED_MODULE_0__["scaleCtx"])(loseCtx, dropX, dropYFrom, dropScale, dropScale);
...
/***/ "./source/js/modules/apply-prize-animation.js":
/*!****************************************************!*\
  !*** ./source/js/modules/apply-prize-animation.js ***!
  \****************************************************/
/*! exports provided: default */
...
const calculateShiftFromRight = (passed, duration, animationStart) => {
  const progress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, animationStart, duration);
...
/* harmony default export */ __webpack_exports__["default"] = (applyPrizeAnimation);


/***/ }),

/***/ "./source/js/modules/apply-win-canvas.js":
/*!***********************************************!*\
  !*** ./source/js/modules/apply-win-canvas.js ***!
  \***********************************************/
/*! exports provided: default */
...
const drawCalf = (passed) => {
  ...
  durations.forEach((el, index) => {
    const progress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, sum, el);
    ...
    if (passed > sum && passed < sum + el) {
      translateCalfY = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(translateFrom, translateTo, progress);
      rotateCalf = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(rotateFrom, rotateTo, progress);
    }
...
const drawSnows = (passed) => {
  ...
  const opacityProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, from, opacityDuration, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const leftStageProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(
      passed,
      snowTranslateFrom,
      snowAnimationDuration
  );
  const rightStageProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(
      passed,
  ...
  if (passed > snowTranslateTo) {
    ...
    leftSnowTranslateY = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
  ...
  if (passed > snowTranslateToDelayed) {
    ...
    rightSnowTranslateY = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
...
const drawTree = (passed) => {
  ...
  showTree = progress * 1;
  translateYTree = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
...
const drawBackAndAirPlane = (passed) => {
  ...
  const animationProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, from, animationDuration);
  const opacityProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getProgress"])(passed, from, opacityDuration, _utils__WEBPACK_IMPORTED_MODULE_0__["easeOut"]);
  const airplaneProgress = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["cubicBezier"])(animationProgress, 0.2, 0, 0.4, 1);

  backOpacity = opacityProgress * 1;

  backRadius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
      backStartRadius,
      maxBackCicleRadius,
      airplaneProgress
  );
  backCenterYPoint = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
      backTopYPoint + backStartRadius,
      backTopYPoint + maxBackCicleRadius,
      airplaneProgress
  );
  const currentPos = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getBezierPoint"])(
      airplaneProgress,
      airplanePathPoint1,
      airplanePathPoint2,
      airplanePathPoint3,
  ...
  curveFirstPoint = {
    x: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
        backXAxios + (airplaneXPosition - backXAxios) * 0.6,
        backXAxios + (airplaneXPosition - backXAxios) * 0.4,
        airplaneProgress
    ),
    y: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
  ...
  arcPointY = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(
  ...
  airplaneRotate = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getAnimationTick"])(aitplaneRotateFrom, 0, airplaneProgress);
...
/***/ "./source/js/modules/game-counter.js":
/*!*******************************************!*\
  !*** ./source/js/modules/game-counter.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (drawCloak);


/***/ }),

/***/ "./source/js/modules/make-result-animation.js":
/*!****************************************************!*\
  !*** ./source/js/modules/make-result-animation.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/make-typegraphy-accent.js":
/*!*****************************************************!*\
  !*** ./source/js/modules/make-typegraphy-accent.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ((elementSelector, rules = defaultRules) => {
  const element =
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _make_result_animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./make-result-animation */ "./source/js/modules/make-result-animation.js");
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        Object(_make_result_animation__WEBPACK_IMPORTED_MODULE_0__["default"])();
      });
    }
...
/*!************************************!*\
  !*** ./source/js/modules/utils.js ***!
  \************************************/
/*! exports provided: rotateCtx, scaleCtx, easeOut, easeIn, easeInOut, getAnimationTick, getBezierPoint, cubicBezier, getProgress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "rotateCtx", function() { return rotateCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scaleCtx", function() { return scaleCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "easeOut", function() { return easeOut; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "easeIn", function() { return easeIn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "easeInOut", function() { return easeInOut; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAnimationTick", function() { return getAnimationTick; });
...
const scaleCtx = (ctx, cx, cy, scaleX, scaleY) => {
  ctx.translate(cx, cy);
  if (scaleY) {
...
const getAnimationTick = (from, to, progress) => {
...
const getProgress = (passed, from, duration, easing = (p) => p) => {
...
/* harmony import */ var _applyTypography_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./applyTypography.js */ "./source/js/applyTypography.js");
/* harmony import */ var _modules_game_counter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/game-counter.js */ "./source/js/modules/game-counter.js");
/* harmony import */ var _modules_apply_prize_animation_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/apply-prize-animation.js */ "./source/js/modules/apply-prize-animation.js");
/* harmony import */ var _modules_apply_win_canvas_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/apply-win-canvas.js */ "./source/js/modules/apply-win-canvas.js");
/* harmony import */ var _modules_apply_lose_canvas_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/apply-lose-canvas.js */ "./source/js/modules/apply-lose-canvas.js");
// modules
...
Object(_applyTypography_js__WEBPACK_IMPORTED_MODULE_10__["default"])();

requestAnimationFrame(_modules_game_counter_js__WEBPACK_IMPORTED_MODULE_11__["default"]);
requestAnimationFrame(_modules_apply_prize_animation_js__WEBPACK_IMPORTED_MODULE_12__["default"]);
requestAnimationFrame(_modules_apply_win_canvas_js__WEBPACK_IMPORTED_MODULE_13__["default"]);
requestAnimationFrame(_modules_apply_lose_canvas_js__WEBPACK_IMPORTED_MODULE_14__["default"]);
